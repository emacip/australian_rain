...
Esta variable indica la cantidad de lluvia en mm del día siguiente, se usa para crear la variable respuesta RainTomorrow. Es como una medida de "riesgo". Es la variable que se ha usado para determinar la variable RainTomorrow.
