...
plot_grid(mintemp, maxtemp, temp9, temp3, press9, press3, humidity9, humidity3, nrow = 4, ncol = 2)
```



Ahora crearemos unas nuevas varibles combinandolas entre si.
Las usaremos en el modelo mas adelante para ajustarlo.
...
plot_grid(AvgTemp, temp, press, humidity, nrow = 4, ncol = 1)
...
```
Creación variables dummies para `Location`, `Season`, `WindGustDir` y borrado de las anteriores.
```{r variables dummies}
